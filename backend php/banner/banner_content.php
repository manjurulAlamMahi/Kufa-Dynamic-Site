                ...
                <div class="col-lg-12">
                    <div class="card user_card">
                        <div class="card-header text-center">
                            <h4>Banner Content Information</h4>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <?php foreach($select_rslt as $key => $banner_contents){ ?>
                                <tr>
                                    <td class="vv">#<?= $key+1 ?></td>
                                    <td class="vv"><?= $banner_contents['sub_title']; ?></td>
                                    <td class="vv"><?= $banner_contents['title']; ?></td>
                                    <td class="vv"><?= substr($banner_contents['description'],0,20) ?>.....</td>
                                    <td class="vv">
                                        <a href="banner_content_act_dct.php?id=<?=$banner_contents["id"]?>"
                                        class="btn btn-<?=($banner_contents['status'] == 1? 'success':'secondary') ?> my_btn">
                                        <?=($banner_contents['status'] == 1? 'Active':'Deactive') ?>
                                    </td>
                                    <td class="vv">
                                        <a href="banner_content_edit.php?id=<?=$banner_contents["id"]?>"
                                            class="btn btn-primary my_btn">Edit</a>
                                        <button type="button" name="banner_content_delete.php?id=<?=$banner_contents["id"]?>"
