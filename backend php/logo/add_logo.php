                    ...
                    <form action="add_logo_post.php" method="POST" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header bg-primary text-white text-center">
                                <h4>Add logormation</h4>
                            </div>
                            <div class="card-body text-center">
                                 <!-- Show Icon  -->
                                <div class="mt-2">
                                    <p class="logo_text">Insert Logo*</p>
                                    <label for="logo_img" class="form-label myButton">Select Logo</label>
                                    <input style="display: none;" type="file" id="logo_img" class="form-control" name="logo" oninput="pic.src=window.URL.createObjectURL(this.files[0])">
                                    <style>
                                        .logo_text{
                                            font-size: 22px;
                                            color: #333;
                            ...
                            <div class="card-footer text-center">
                                <button class="btn btn-primary myButton_submit" type="submit">ADD LOGO</button>
                                <style>
                                    .myButton_submit {
