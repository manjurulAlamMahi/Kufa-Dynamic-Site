                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td class="user_header_text">Office Address</td>
                                    <td class="user_header_text">Office At</td>
                                    <td class="user_header_text">Phone Number</td>
                                    <td class="user_header_text">Email Address</td>
                                    <td class="user_header_text">Details</td>
                                    <td class="user_header_text">Status</td>
                                    <td class="user_header_text">Action</td>
                                </tr>
                                <?php foreach($select_rslt as $key => $info){ ?>
                                <tr>
                                    <td class="vv">#<?= $key+1 ?></td>
                                    <td class="vv"><?= substr($info['address'],0,10) ?>...</td>
                                    <td class="vv"><?= $info['office_at']; ?></td>
                                    <td class="vv"><?= $info['number']?></td>
                                    <td class="vv"><?= $info['email']; ?></td>
                                    <td class="vv"><?= substr($info['details'],0,20) ?>....</td>
                                    <td class="vv">
                                        <a href="act_dct_info.php?id=<?=$info["id"]?>"
                                        class="btn btn-<?=($info['status'] == 1? 'success':'secondary') ?> my_btn">
                                        <?=($info['status'] == 1? 'Active':'Deactive') ?>
                                    </td>
                                    <td class="vv">
                                        <a href="edit_info.php?id=<?=$info["id"];?>" class="btn btn-info my_btn mb-2">Edit</a>
                                        <button type="button" name="delete_info.php?id=<?=$info["id"]?>"
