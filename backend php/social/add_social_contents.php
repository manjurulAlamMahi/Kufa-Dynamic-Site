        ...
        <div class="sl-page-title">
            <div class="row">
                <div class="col-lg-6 m-auto align-self-center">
                    <!-- Add Social Content -->
                    <form action="add_social_contents_post.php" method="POST">
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                <h4>Add Social Content</h4>
                            </div>
                            <div class="card-body">
                                 <!-- Show Icon  -->
                                 <div class="card">
                                    ...
                                    <?php foreach($social_fonts as $social_icons){?>
...
<?php if(isset($_SESSION['social_content_added'])){ ?>
<script>
    Swal.fire({
        position: 'top-center',
        icon: 'success',
        title: '<?= $_SESSION['social_content_added']; ?>',
        showConfirmButton: false,
        timer: 1500
    })
</script>
<?php } unset($_SESSION['social_content_added']); ?>
<!-- banner content added  Success -->