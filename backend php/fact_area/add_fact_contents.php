        ...
        <div class="sl-page-title">
            <div class="row">
                <div class="col-lg-6 m-auto align-self-center">
                    <!-- Add Social Content -->
                    <form action="add_fact_contents_post.php" method="POST">
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                <h4>Add Fact Area Content</h4>
                            </div>
                            <div class="card-body">
                                 <!-- Show Icon  -->
                                 <div class="card">
                                ...
                                <!-- Service Title -->
                                <div class="mb-3">
                                    <label class="form-label">Countdown Number</label>
                                ...
                                <!-- ERROR -->
                                <?php if(isset($_SESSION['fact_empty_err'])){ ?>
                                <div class="alert alert-danger"><?= $_SESSION["fact_empty_err"]; ?></div>
                                <?php } unset($_SESSION['fact_empty_err']); ?>
                            </div>
